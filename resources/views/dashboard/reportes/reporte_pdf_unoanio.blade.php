    ...
    <tbody>
        <tr>
            <td style="width: 750px;" class="titulo">
                <h1 class="titulo__principal">Cantidad de empresas inscritas por año</h1>
            </td>
        </tr>
    </tbody>
</table>
    ...
    <tbody>
        <tr>
            <td style="width: 450px;">
                <span style="font-size: 14px;"><strong>Reporte de año: </strong><span id="nombres">{{ $year }}</span></span><br>
            </td>
            <td>
...
<div style="display: inline-block; width: 70%;">
    <span style="display: block;">Reporte inscritos por año</span>

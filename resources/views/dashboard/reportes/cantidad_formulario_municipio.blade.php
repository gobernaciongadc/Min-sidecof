    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="text-uppercase text-center mt-2">Cantidad de empresas por municipio</h5>
                            ...
                            <div class="form-group borde-consulta p-4">
                                ...
                                <div class="row">
                                    <div class="col-12  name-empresa">
                                        ...
                                        <select class="select-reporte-uno" name="municipio" style="width: 100%;" id="municipios">
                        ...
                        <script>
                            document.addEventListener('DOMContentLoaded', () => {
                                ...
                                $("#consulta-reporte").click(() => {
                                    ...
                                    const municipioId = $("#municipios").val();
                                    ...
                                    $.ajax({
                                        ...
                                        url: "{{route('admin.resultadosreporteunomunicipio')}}", // Reemplaza con la URL correcta de tu controlador
                                        data: datos,
                                        success: function(response) {
                                            ...
                                            if (status === 'success' && listaEmpresas.length != 0) {
                                                ...
                                                let filaTotal = '<tr>' +
                                                        ...
                                                        <td colspan="3">
                                                            <div class="col-md-12">
                                                                <div class="pull-right m-t-30 text-right">
                                                                    <hr>
                                                                    <h5><b>Total candidad de empresas por municipio :</b> <span>${cantidadEmpresas}</span></h5>
                                                                </div>
                                                    ...
                                                    ` +
                                                    '</tr>';
                                                $('#reporte-uno').append(filaTotal);

                                                // FIN Para el año****************                              

                                                const municipioId = municipio.id;
                                                let btn_imprimir = `
                                                        <a  href="/pdfreporteunomunicipio/${municipioId}" target="_blank" id="btn-reporte-uno" class="btn btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Imprimir">
                    ...
                    <div class="reporte-cant-formulario borde-consulta d-none" id="primer-reporte">
                        ...
                        <div class="datos-reporte">
                            <h5 class="text-center text-uppercase">Cantidad de empresas por municipio</h5>

                            <div class="row mt-5">
                                <div class="col-12 col-md-6">
                                    <p class="mb-1"><strong>Municipio: </strong><span id="municipio"></span></p>
                                </div>
                                <div class="col-12 col-md-6">
                                ...
                                <div class="col-md-4" id="miTabla">
                                    <div class="table-responsive" style="clear: both;">
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    <td class="header" colspan="3" data-f-sz="18" data-f-color="" data-a-h="center" data-a-v="middle" data-f-underline="true">
                                                        <p class="text-uppercase text-danger"><strong>Reporte empresas por municipio <span id="anio-uno"></span></strong></p>

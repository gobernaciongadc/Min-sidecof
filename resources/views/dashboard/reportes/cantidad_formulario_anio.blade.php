...
<li class="breadcrumb-item active">Empresas por municipios</li>
@endsection
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="text-uppercase text-center mt-2">Cantidad de empresas de empresas inscritas por año</h5>
                    <div class="row justify-content-center">
                            ...
                            <div class="form-group borde-consulta p-4">
                                ...
                                <div class="row">
                                    <div class="col-12  name-empresa">
                                        <label for="">Año de inscripción</label><br>
                                        <input type="number" class="form-control" id="anio" placeholder="Ingrese un año">
                                    </div>
                        ...
                        <script>
                            document.addEventListener('DOMContentLoaded', () => {
                                ...
                                const anioInscripcion = document.getElementById('anioInscripcion');
                                const fechaInput = document.getElementById('fecha');
                                const totalInput = document.getElementById('total');

                                const btn_reporte_uno = document.getElementById('btn-reporte-uno');

                                // Escuchar el evento keypress en el input con ID 'anio'
                                $('#anio').keypress(function(event) {
                                    // Verificar si la tecla presionada es Enter (código 13)
                                    if (event.which === 13) {
                                        // Llamar a la función o evento que deseas disparar
                                        anios();
                                    }
                                });
                                ...
                                function anios() {
                                    ...
                                    $.ajax({
                                        ...
                                        url: "{{route('admin.resultadosreporteunoanio')}}", // Reemplaza con la URL correcta de tu controlador
                                        data: datos,
                                        success: function(response) {
                                            ...
                                            if (status === 'success' && listaEmpresas.length != 0) {
                                                ...
                                                anioInscripcion.innerText = anio;
                                                ...
                                                for (let i = 0; i < listaEmpresas.length; i++) {
                                                    ...
                                                    let newRow = '<tr>' +
                                                        ...
                                                        '<td>' + rowData.fecha_inscripcion + '</td>' +
                                                    ...
                                                    `<td colspan="4">
                                                        <div class="col-md-12">
                                                            <div class="pull-right m-t-30 text-right">
                                                                <hr>
                                                                <h5><b>Total candidad de empresas por año :</b> <span>${cantidadEmpresas}</span></h5>
                                                            </div>
                                                ...
                                                let btn_imprimir = `
                                                        <a  href="/pdfreporteunoanio/${anio}" target="_blank" id="btn-reporte-uno" class="btn btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Imprimir">
                    ...
                    <div class="reporte-cant-formulario borde-consulta d-none" id="primer-reporte">
                        ...
                        <div class="datos-reporte">
                            <h5 class="text-center text-uppercase">Cantidad de empresas inscritas por año</h5>

                            <div class="row mt-5">
                                <div class="col-12 col-md-6">
                                    <p class="mb-1"><strong>Reporte Año: </strong><span id="anioInscripcion"></span></p>
                                </div>
                                <div class="col-12 col-md-6">
                            ...
                            <div class="row mt-3">
                                ...
                                <!-- REPORTE UNO -->
                                <div class="col-md-10" id="miTabla">
                                    <div class="table-responsive" style="clear: both;">
                                        <table class="table table-hover">
                                            <thead>
                                                <tr>
                                                    <td class="header" colspan="4" data-f-sz="18" data-f-color="" data-a-h="center" data-a-v="middle" data-f-underline="true">
                                                        <p class="text-uppercase text-danger"><strong>Reporte por año de inscripción <span id="anio-uno"></span></strong></p>
                                                    </td>
                                                </tr>
                                                <tr>

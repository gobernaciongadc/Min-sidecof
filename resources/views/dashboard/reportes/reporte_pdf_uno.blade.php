    ...
    <tbody>
        <tr>
            <td style="width: 750px;" class="titulo">
                <h1 class="titulo__principal">Cantidad de formularios por actor productivo</h1>
            </td>
        </tr>
    </tbody>
</table>
    ...
    <tbody>
        <tr>
            <td style="width: 450px;">
                <span style="font-size: 14px;"><strong>Empresa/Cooperativa: </strong><span id="nombres">{{ $empresa->nombres }}</span></span><br>
                <span style="font-size: 14px;"><strong>Minerales permitidos: </strong><span id="metales">{{ $empresa->mineral }}</span></span><br>
                <span style="font-size: 14px;"><strong>Nro. NIM: </strong><span id="nim">{{ $empresa->nro_nim }}</span></span>
            </td>
            <td>
                <span style="font-size: 14px;"><strong>Nro. Ruim: </strong><span id="ruim">{{ $empresa->ruim }}</span></span><br>
                <span style="font-size: 14px;"><strong>Estado: </strong><span id="estado">{{ $empresa->estado }}</span></span><br>
...
<div>
    ...
    <div style="display: inline-block; width: 29%;">
        <span style="display: block;">Reporte año {{ $year }}</span>
        <table class="reporte-uno" style="float: left; margin-right: 20px; width: 100%;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $resultado->total_formularios }}</td>
                </tr>
                @endforeach
    ...
    <table>
        <tbody>
            <tr>
                <td class="titulo">
                    <h1 class="titulo__principal"><strong>Cantidad total de formularios en el Año actual:</strong><span> {{ $resultadoTotal->total_formularios }}</span> </h1>
                </td>
            </tr>
        </tbody>
    </table>
    ...
    <div style="display: inline-block; width: 29%;">
        <span style="display: block;">Reporte año {{ $year-1 }}</span>
        <table class="reporte-uno" style="float: left; margin-right: 20px; width: 100%;">
            <thead>
                <tr>
                    <th>#</th>
            ...
            <tbody>
                ...
                @foreach($resultadosPorMesDos as $resultado)
                <tr>
                    <td>{{ $loop->iteration }}</td>
                    <td>
                        @switch($resultado->mes)
    ...
    <table>
        <tbody>
            <tr>
                <td class="titulo">
                    <h1 class="titulo__principal"><strong>Cantidad total de formularios en 2 Años:</strong><span> {{ $resultadoTotal->total_formularios + $resultadoTotalDos->total_formularios }}</span> </h1>
                </td>
            </tr>
        </tbody>
    </table>
    ...
    <div style="display: inline-block; width: 29%;">
        <span style="display: block;">Reporte año {{ $year-2 }}</span>
        <table class="reporte-uno" style="float: left; margin-right: 20px; width: 100%;">
            <thead>
                <tr>
                    <th>#</th>
            ...
            <tbody>
                ...
                @foreach($resultadosPorMesTres as $resultado)
                <tr>
                    <td>{{ $loop->iteration }}</td>
                    <td>
                        @switch($resultado->mes)
    ...
    <table>
        <tbody>
            <tr>
                <td class="titulo">
                    <h1 class="titulo__principal"><strong>Cantidad total de formularios en 3 Años es:</strong><span> {{ $resultadoTotal->total_formularios + $resultadoTotalDos->total_formularios + $resultadoTotalTres->total_formularios }}</span> </h1>
                </td>
            </tr>
        </tbody>
    </table>

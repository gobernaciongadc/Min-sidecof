    ...
    <tbody>
        <tr>
            <td style="width: 750px;" class="titulo">
                <h1 class="titulo__principal">Cantidad de empresas por mineral autorizado</h1>
            </td>
        </tr>
    </tbody>
</table>
    ...
    <tbody>
        <tr>
            <td style="width: 450px;">
                <span style="font-size: 14px;"><strong>Mineral autorizado: </strong><span id="nombres">{{ $minerales }}</span></span><br>
            </td>
            <td>
...
<div style="display: inline-block; width: 70%;">
    <span style="display: block;">Reporte de empresas por mineral</span>
    <table class="reporte-uno" style="float: left; margin-right: 20px; width: 100%;">
        <thead>
            <tr>
                <th>#</th>
                <th>Empresa/Cooperativa</th>
                <th>Mineral autorizado</th>
                <th>Estado actual</th>
            </tr>
        </thead>
        <tbody>

            @foreach($listaEmpresas as $index => $empresa)
            <tr>
                <td>{{ $index + 1 }}</td>
...
<table>
    <tbody>
        <tr>
            <td class="titulo">
                <h1 class="titulo__principal"><strong>Total candidad de empresas por mineral autorizado:</strong><span> {{ $cantidadEmpresas }}</span> </h1>
            </td>
        </tr>
    </tbody>
</table>
